...
parser.add_argument('--finetune', type=str, nargs="+", required=False, help="list of the module to finetune", default=[])
...
if args.model == 'ast' or args.model == 'ssast':
    ...
    if args.model == 'ast':
        audio_model = models.ASTModel(label_dim=args.n_class, fstride=args.fstride, tstride=args.tstride, input_fdim=128,
                                  ...
                                  audioset_pretrain=args.audioset_pretrain, model_size='base384', adapter=args.finetune)
    elif args.model == 'ssast':
        # audio_model = models.SSASTModel(label_dim=args.n_class, fstride=args.fstride, tstride=args.tstride,
        #                               input_fdim=128,
        #                               input_tdim=args.audio_length, imagenet_pretrain=args.imagenet_pretrain,
        #                               audioset_pretrain=args.audioset_pretrain, model_size='base384',
        #                               adapter=args.finetune)
        audio_model = models.SSASTModel(label_dim=args.n_class, fshape=16, tshape=16, fstride=args.fstride,
                               tstride=args.tstride,
                               input_fdim=128, input_tdim=args.audio_length, model_size='base',
                               pretrain_stage=False, adapter=args.finetune)
...
if args.dataset == 'speechcommands' or args.dataset == 'gtzan':
